...
public final class FireReceiver extends BroadcastReceiver {
     ...
     * @param intent  the incoming {@link com.locale.twofortyfouram.Intent#ACTION_FIRE_SETTING} Intent. This
     *                should contain the {@link com.locale.twofortyfouram.Intent#EXTRA_BUNDLE} that was saved by
    ...
    public void onReceive(final Context context, final Intent intent) {
         ...
         */
        if (!com.locale.twofortyfouram.Intent.ACTION_FIRE_SETTING.equals(intent.getAction())) {
            return;
        }
        ...
        BundleScrubber.scrub(intent.getBundleExtra(com.locale.twofortyfouram.Intent.EXTRA_BUNDLE));
        final Bundle bundle = intent.getBundleExtra(com.locale.twofortyfouram.Intent.EXTRA_BUNDLE);
