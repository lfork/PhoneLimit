...
public class LocaleEdit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle paramBundle) {
        ...
        BundleScrubber.scrub(getIntent().getBundleExtra(
                com.locale.twofortyfouram.Intent.EXTRA_BUNDLE));
    ...
    public void finish() {
        if (mIsCancelled) {
            ...
            if (!G.isProfileMigrated()) {
                ...
                resultIntent.putExtra(com.locale.twofortyfouram.Intent.EXTRA_BUNDLE, PluginBundleManager.generateBundle(getApplicationContext(), idx + "::" + action));
            } else {
                resultIntent.putExtra(com.locale.twofortyfouram.Intent.EXTRA_BUNDLE, PluginBundleManager.generateBundle(getApplicationContext(), selectedId + "::" + action));
            }
            resultIntent.putExtra(com.locale.twofortyfouram.Intent.EXTRA_STRING_BLURB, action);
